...
//拖拽
#define DUI_MSGTYPE_DRAG				   (_T("drag"))
#define DUI_MSGTYPE_DROP				   (_T("drop"))
...
//拖拽事件
#define DUI_MSGTYPE_DROPENTER			   (_T("dropenter"))
#define DUI_MSGTYPE_DROPLEAVE			   (_T("dropleave"))
...
#define DUI_MSGTYPE_TREEEXPAND				(_T("treexpand"))
